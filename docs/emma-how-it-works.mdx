...
For these leads, a **sales-focused follow-up** [**Sequences**](emma-settings#emma-sequence) flow is immediately connected.  
...
<div>
  First, an [**triggered campaign**](emma-settings#emma-campaign) that includes **onboarding content** is sent to continuously track lead responses. Lead status is re-evaluated based on predefined criteria.
  <ul style={{ marginTop: "-2px", marginBottom: "-8px" }}>
    ...
    <li>When criteria are not met: **nurturing** is continuously carried out through [one-off campaigns](emma-settings#emma-campaign) (such as newsletters).</li>
  </ul>
</div>
