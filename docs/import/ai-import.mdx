...
"og:title": "AI Import | Spread Product Guide"
"og:description": "Import contacts with AI"
"og:image": "https://relateso.sirv.com/spread/spread-docs.png"
"twitter:title": "AI Import | Spread Product Guide"
"twitter:description": "Import contacts with AI"
"twitter:image": "https://relateso.sirv.com/spread/spread-docs.png"
---

## Overview

AI Import imports Contacts/Organizations into Spread using a CSV/Excel file.
...
<Accordion title="3. Custom fields">
  ...
  During AI Import, Spread AI analyzes each column in the file.
...
<Accordion title="How is AI Import different from the previous import method?">
  ...
  AI Import allows Spread AI to automatically understand and map column data without any prior field setup.
</Accordion>
