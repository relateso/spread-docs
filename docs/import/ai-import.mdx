...
<Accordion title="1. Import data types">
  ...
  <img
    src="/images/ai-import-ss/type-eng.jpeg"
...
<img src="/images/ai-import-ss/ws.jpeg" alt="Workspace settings" width="300" style={{ display: "block", margin: "4px 0 12px 32px", boxShadow: "0 6px 18px rgba(0, 0, 0, 0.16)", borderRadius: "8px" }} />

- Select `Import` from the left sidebar, and click `Import contacts` in the top-right corner.
  <img
    src="/images/ai-import-ss/all.eng.jpeg"
    alt="Upload file"
    style={{
      display: "block",
      margin: "12px auto 0",
...
After uploading the file, select how to handle duplicate data.
  <img
    src="/images/ai-import-ss/duplicate.png"
...
<img
  src="/images/ai-import-ss/1.eng.jpeg"
  alt="1"
  style={{
    display: "block",
    margin: "12px auto 0",
...
<Tip>
  ...
  <div style={{ display: "grid", gap: "4px", marginLeft: "-20px" }}>
    <div style={{ display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
      <img src="/images/ai-import-ss/contact_icon.png" alt="Contact Field" width="15" />
      <span style={{ fontWeight: 600 }}>Contact Field:</span>
      <span>Selected columns are imported as **Contacts**.</span>
    </div>
    <div style={{ display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
      <img src="/images/ai-import-ss/org_icon.png" alt="Organization Field" width="15" />
...
- If there is no suitable field to map, you can click `Add a custom field` in the top-right corner to create a new field and map it immediately.
    ...
    <img
      src="/images/ai-import-ss/add-eng.png"
...
<img
  src="/images/ai-import-ss/import-result.png"
  alt="import-result"
  style={{
    display: "block",
    margin: "0 auto",
...
<img
  src="/images/ai-import-ss/failed.png"
  alt="failed records"
  style={{
    display: "block",
    margin: "0 auto",
...
<img
  src="/images/ai-import-ss/makeprocess.png"
...
<img
  src="/images/ai-import-ss/importfromcsv.png"
...
<Accordion title="Korean characters are broken when importing a CSV file. How can I fix this?">
  ...
  **1. In Microsoft Excel, go to the Data tab and click Get Data (Power Query)**
  <img src="/images/ai-import-ss/export1.png" alt="export1" width="360" />
    
  **2. Click Text/CSV and select the file with broken characters**
  <img src="/images/ai-import-ss/export2.png" alt="export2" width="360" />

  **3. Select UTF-8 and click Load**
  <img src="/images/ai-import-ss/export3.png" alt="export3" width="360" />
</Accordion>
